<div id="teacherNoticesView" class="view active">
    <!-- Notice board actions for teacher -->
    <div style="padding: 16px 16px 8px; display: flex; gap: 8px;">
        <div style="display: flex; align-items: center; background: rgba(142, 124, 195, 0.06); border: 1px solid rgba(142, 124, 195, 0.15); border-radius: 12px; padding: 10px 14px; gap: 8px; flex: 1;">
        ...
        <button onclick="showToast('Upload Notice clicked')" style="background: var(--brand-color); color: white; border: none; border-radius: 12px; padding: 0 16px; display: flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 500; cursor: pointer; transform: scale(1); transition: transform 0.1s ease;">
            <i class="ph ph-plus" style="font-size: 16px;"></i> Upload
        </button>
    </div>
